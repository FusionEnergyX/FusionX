# Linearize
Construct a linear, no-fork, best version of the Fusion blockchain. The scripts
...
JSON-RPC server. Running `fusiond` or `fusion-qt -server` will be sufficient.
...
* `input`: fusiond blocks/ directory containing blkNNNNN.dat
