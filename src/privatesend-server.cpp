...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Fusion related functionality
...
/*
    ...
    allow endless transaction that would bloat Fusion and make it unusable. To
