...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Fusion address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "fusion",               "masternode",             &masternode,             true,  {} },
    { "fusion",               "masternodelist",         &masternodelist,         true,  {} },
    { "fusion",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "fusion",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "fusion",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "fusion",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
