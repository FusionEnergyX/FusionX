...
{
        const char* pszTimestamp = "fusionenergyx.com 18th march 2019";
...
public:
    CMainParams() {
            ...
            consensus.nBudgetPaymentsCycleBlocks = 15000;
            consensus.nBudgetPaymentsWindowBlocks = 100;
            consensus.nSuperblockStartBlock = 50000;
            ...
            consensus.DIP0001Height = 10000000;
	    ...
	    genesis = CreateGenesisBlock(1552867200, 1546003, 0x1e0ffff0, 1, 50 * COIN);
            ...
            strSporkAddress = "FkvfxqXCuqHyaKLyefuJCZD77gwe7rM1J7";
...
public:
    CTestNetParams() {
            ...
            consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
            consensus.nPowTargetTimespan = 60 * 60 * 24; // fusion: 1 day
            consensus.nPowTargetSpacing = 2 * 60; // fusion: 2 minutes
            ...
            vSeeds.push_back(CDNSSeedData("testnetseed.fusioncentral.org", "testnetseed.fusioncentral.org"));
            vSeeds.push_back(CDNSSeedData("testnetseed2.fusioncentral.org", "testnetseed2.fusioncentral.org"));


            // Testnet fusion addresses start with 'y'
            base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
            // Testnet fusion script addresses start with '8' or '9'
            base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
            // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
            base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
            // Testnet fusion BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
            base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
            // Testnet fusion BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
            base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

            // Testnet fusion BIP44 coin type is '1' (All coin's testnet default)
            nExtCoinType = 1;
...
public:
    CDevNetParams() {
            ...
            consensus.nPowTargetTimespan = 24 * 60 * 60; // Fusion: 1 day
            consensus.nPowTargetSpacing = 2.5 * 60; // Fusion: 2.5 minutes
            consensus.fPowAllowMinDifficultyBlocks = true;
            consensus.fPowNoRetargeting = false;
            ...
            vFixedSeeds.clear();
            vSeeds.clear();
            //vSeeds.push_back(CDNSSeedData("fusionevo.org",  "devnet-seed.fusionevo.org"));
...
public:
    CRegTestParams() {
            ...
            consensus.nPowTargetTimespan = 24 * 60 * 60; // fusion: 1 day
            consensus.nPowTargetSpacing = 120; // fusion: 2.5 minutes
            consensus.fPowAllowMinDifficultyBlocks = true;
            ...
            base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
            // Regtest fusion script addresses start with '8' or '9'
            base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
            // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
            base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
            // Regtest fusion BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
            base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
            // Regtest fusion BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
            base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

            // Regtest fusion BIP44 coin type is '1' (All coin's testnet default)
            nExtCoinType = 1;
    }
