...
Below are some notes on how to build FusionX for Windows.
...
way. This will install to `c:\workspace\fusion`, for example:

    make install DESTDIR=/mnt/c/workspace/fusion
